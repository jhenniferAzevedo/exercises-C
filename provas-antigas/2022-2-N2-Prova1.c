...
Implementar o seguinte problema em linguagem C, de forma a conter pelo menos alguma matriz 
(de 2 ou de 3 dimensões) e pelo menos uma função (com parâmetro e valor de retorno).
...
Cálculo do frete: Se o pedido tem menos que 1000kg, o frete é grátis. Se tem de 1001kg a 2000kg, 
o frete é R$ 100,00 para Palmas e 200,00 para Porto Nacional. Se tiver mais que 2000kg, o valor do
